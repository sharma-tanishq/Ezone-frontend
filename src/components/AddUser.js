...
function AddUser(props) {
    ...
    const createUser=async()=>{
        ...
        const response = await fetch("https://ezone-api.herokuapp.com/table/createuser", {
            method: "POST",
            headers: {
                ...
                <div className="lg:w-1/2 md:w-2/3 mx-auto">
                    <div className="flex flex-wrap -m-2">
                        ...
                        <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
                            <a className="text-indigo-500">ezone@email.com</a>
                            <p className="leading-normal my-5">Marathahalli <br /> Bengaluru, Karnataka 560037
                            </p>
